...
#def Plant_classes():
#0  , 0   , 255	Bleu, 	leaf
#255, 255 , 0 	yellow 	bellpepper
#255, 0   , 255 	pink 	node at stem section
#0  , 255 , 0   	green 	leaf stem, sideshoot
#255, 0   , 0  	red, 	pedoncule
#0  , 255 , 255	light 	blue cuts
#255, 255 , 255	white 	wires
#0  , 0   , 0	black 	backgrounnd
def pascal_palette():
  palette = {  (  0,   0, 255),
	       (255, 255,   0),
	       (255,   0, 255),
